-- ============================================================
-- zzz_ safety-net: runs on every server startup.
-- Ensures strategy tables always exist regardless of migration
-- tracking state. This file MUST be in backend/db/migrations/
-- (not backend/src/db/migrations/) so it is found at runtime
