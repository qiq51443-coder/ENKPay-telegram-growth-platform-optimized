-- Migration 1005: Fix type mismatches for pair_id and rule_id columns
-- Several migrations added these columns as UUID when they should be INTEGER.
-- This migration detects and corrects those type mismatches idempotently.
