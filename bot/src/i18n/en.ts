export const en = {
  ...
  invites_your_code: 'Your Invite Code',
  invites_link: 'Invitation Link',
  invites_total: 'Total Invites',
  invites_reward_per_invite: 'Reward per invite',
  invites_share_message: '🎁 Join me on the Growth Platform and earn rewards!',

  // Balance
  balance_title: '💰 Your Balance',
  balance_current: 'Current Balance',
  balance_total_earned: 'Total Earned',
  balance_recent_transactions: 'Recent Transactions',
  balance_withdraw_button: 'Withdraw',
  ...
  redpacket_no_credits: '❌ You need red packet credits to claim. Complete tasks to earn credits!',
  ...
  withdraw_submitted: 'Withdrawal request submitted, awaiting admin review',
  withdraw_submitted_time: 'Submitted at',
  withdraw_pending_info: 'You will be notified once the review is complete',
  withdraw_balance_hint: 'Current balance: {balance} USDT',
  withdraw_fee_hint: 'Fee: {fee} USDT ({fee_rate}%), actual received: {actual} USDT',
